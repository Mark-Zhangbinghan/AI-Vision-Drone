...
class MediaDetectGUI:
    ...
    def __init__(self, stage1_path=None, stage2_path=None,
        ...
        # ---- Pipeline mode ----
        # "standard" = 单帧三分支判定 | "temporal" = 90帧滑窗投票 (DrowningTracker)
    ...
    def _build_controls(self):
        ...
        mode_temporal = tk.Radiobutton(mode_group, text="时序模式 (90帧投票, 抑制误报)",
    ...
    def _on_mode_change(self):
        ...
        if old_mode != self.pipeline_mode:
            ...
            self._update_status(f"Pipeline mode: {'Temporal 90f vote)' if self.pipeline_mode == 'temporal' else 'Standard (single-frame)'}")
    ...
    def _get_or_create_tracker(self):
        ...
        if self._tracker is None:
            self._tracker = _pipeline_temporal.DrowningTracker(
                window_size=90, alarm_ratio=0.6, stale_frame_threshold=60)
